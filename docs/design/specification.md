...
- **Gate (T1 → T2):** an **end-to-end test suite** that fakes a Claude Code session
  and drives the system e2e ([testing.md](../develop/testing.md)).
...
| CLI | **Bun + Ink** | Same stack as Claude Code; generated API client; optional interface + admin tool. [cli.md](../reference/cli.md) |
...
Full steps in [`README.md`](../../README.md), [hook-setup.md](../start/hook-setup.md), and
...
|-----------|------|------|-----------|
| **hook** | `hooks/` | Claude Code plugin (writer). Logs through the webapi path to CouchDB + S3. Per machine. | [hook.md](../reference/hook.md) |
| **webapi** | `packages/webapi/` | The I/O gateway + stability column; ensures the CouchDB schema; serves the SPA + Swagger in prod. | [webapi.md](../reference/webapi.md) |
| **webui** | `packages/webui/` | Optional React SPA: list, detail, transcript viewer. Generated API client. | [webui.md](../reference/webui.md) |
| **CLI** | _(planned package)_ | Optional Bun + Ink terminal client + admin tool; generated API client. | [cli.md](../reference/cli.md) |
| **shared** | `packages/shared/` | Cross-cutting domain types + `sumTranscriptTokens`. | [webapi.md](../reference/webapi.md#packagesshared) |
| **scripts** | `scripts/` | Dev-only automation + operational helpers: transcript parsing, `backfill`, reconcile, export/import, migrations. | [cli.md](../reference/cli.md) |
...
[hooks.md](../reference/hooks.md); the behaviour catalogue + current bindings are
[actions.md](../reference/actions.md).
...
Detail in [containers.md](../operate/containers.md).

## 17. Decision records (ADRs)

Non-obvious decisions are recorded in [`decisions/`](decisions/README.md) (format:
